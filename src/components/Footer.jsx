...
export default function Footer() {
    return (
        <footer className="w-full bg-[#004A99] text-white rounded-t-2xl mt-20 relative z-20">
            <div className="max-w-6xl mx-auto px-10 py-10 grid md:grid-cols-3 gap-10">
                ...
                <div className="text-center">
                    ...
                    <div className="flex justify-center gap-4">
                        ...
                        {/* Facebook */}
                        <div
                            className="bg-white text-[#004A99] p-2 rounded-full w-10 h-10 flex items-center justify-center">
