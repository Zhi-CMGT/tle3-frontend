...
const HomeHeader = ({user, userLoading, allItems, recommendations, mainHeadingRef}) => {
    return (
        <header className="relative overflow-hidden">
            ...
            <div className="relative z-10 max-w-6xl mx-auto px-6 pt-12 pb-20 flex flex-col items-center text-center">

                {/* Main heading - target for skip link */}
                <h1
                    ref={mainHeadingRef}
                    tabIndex="-1"
                    className="text-4xl md:text-5xl font-black text-white mb-3 tracking-tight leading-tight"
                >
                ...
                {!userLoading && user ? (
                    <div className="flex flex-col lg:flex-row items-stretch gap-6 w-full max-w-4xl">
                        ...
                        {/* Relevant section */}
                        <div className="lg:w-72 bg-white rounded-2xl shadow-xl px-6 py-5 flex flex-col gap-1 text-left">
